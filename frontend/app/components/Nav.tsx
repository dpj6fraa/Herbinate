  ...
  return (
    <nav className="flex flex-col text-[24px] text-black pt-3 px-4 sticky top-0 w-full z-50 bg-white border-b-4 border-b-[#97DB8B]">
      <div className="flex justify-between items-center">
        {/* แก้ตรงนี้: หุ้ม Logo ด้วย Link ไปที่ /homepage */}
        <Link href="/homepage">
          <h1 className="font-black hover:opacity-80 transition-opacity cursor-pointer">Herbinate</h1>
        </Link>
      ...
      <div className="flex justify-center mb-1">
        <div className="flex w-full max-w-md justify-between text-black">
          ...
          {/* แก้ตรงนี้: ชุมชน -> /post/feed */}
          <div className="flex flex-col items-center mt-3 sm:mt-4 md:mt-5 cursor-pointer">
            <Link href="/post/feed" className="flex flex-col items-center cursor-pointer gap-0.5">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
