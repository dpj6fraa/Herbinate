...
import { usePathname } from "next/navigation"; // 🌟 นำเข้า usePathname เพื่อเช็คหน้าปัจจุบัน
...
export default function Nav() {
  ...
  const pathname = usePathname(); // 🌟 เก็บค่า URL หน้าปัจจุบัน
  ...
  return (
    <nav className="flex flex-col text-[24px] text-black pt-3 px-4 sticky top-0 w-full z-50 bg-white border-b-4 border-b-[#97DB8B] shadow-sm">
      <div className="flex justify-between items-center">
        <Link href="/homepage">
          <h1 className="font-black hover:opacity-70 transition-opacity cursor-pointer text-[#000000]">
            Herbinate
          </h1>
        </Link>

        {/* 🌟 แสดง Skeleton Loading หรือปุ่มตามสถานะ */}
        {loading ? (
          ...
          <Link href="/profile">
            <img
              ...
              className="w-11 h-11 rounded-full object-cover cursor-pointer hover:ring-4 hover:ring-[#97DB8B] hover:scale-105 transition-all duration-300"
              alt="profile"
            />
          </Link>
        ) : (
          <Link
            href="/login"
            className="text-sm font-semibold px-5 py-2 border-2 border-[#97DB8B] rounded-full text-[#1C7D29] hover:bg-[#97DB8B] hover:text-white transition-colors duration-300 shadow-sm"
          >
            Login
          </Link>
        )}
        ...
        <div className="flex w-full max-w-md justify-between text-black">
          ...
          <div className="flex flex-col items-center mt-3 sm:mt-4 md:mt-5 cursor-pointer">
            ...
            >
              ...
              <h3 className="text-xs sm:text-[13px] font-medium">หน้าแรก</h3>
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center mt-3 sm:mt-4 md:mt-5 cursor-pointer">
            ...
            >
              ...
              <h3 className="text-xs sm:text-[13px] font-medium">ชุมชน</h3>
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center mt-3 sm:mt-4 md:mt-5 cursor-pointer">
            ...
            >
              ...
              <h3 className="text-xs sm:text-[13px] font-medium">ค้นหาอาการ</h3>
            </Link>
          </div>
          ...
          <div className="flex flex-col items-center mt-3 sm:mt-4 md:mt-5 cursor-pointer">
            ...
            >
              <svg className={`w-[22px] h-[22px] transition-transform duration-300 ${isActive('/Image/Search') ? '-translate-y-1' : 'group-hover:-translate-y-1'}`} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M17 22H21C21.5523 22 22 21.5523 22 21V17" stroke="currentColor" strokeWidth={2} strokeLinecap="round" />
                <path d="M11.8 19C11.8 19 5.5 17.5 5 13C4.5 9.5 9 9 11.8 14" fill="currentColor" />
                <path d="M12.2 19C12.2 19 18.5 17.5 19 13C19.5 9.5 15 9 12.2 14" fill="currentColor" />
                <path d="M12 16C14 14 15 11 12 5C9 11 10 14 12 16Z" fill="currentColor" />
              </svg>
              <h3 className="text-xs sm:text-[13px] font-medium">ค้นหารูป</h3>
            </Link>
          </div>
            ...
            >
              <svg className={`w-[22px] h-[22px] transition-transform duration-300 ${isActive('/compare') ? '-translate-y-1' : 'group-hover:-translate-y-1'}`} viewBox="0 0 400 450" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g transform="scale(1.2) translate(-35, -20)">
                  <path d="M200 180V300M150 380L200 300L250 380H150Z" stroke="currentColor" strokeWidth="12" strokeLinecap="round" strokeLinejoin="round" fill="currentColor" />
                  <rect x="70" y="240" width="260" height="12" rx="6" fill="currentColor" />
                  <path d="M70 310C70 345 100 370 135 370C170 370 200 345 200 310H70Z" fill="currentColor" transform="translate(0, -50)" />
                  <circle cx="135" cy="150" r="70" fill="currentColor" />
                  ...
                  <path d="M200 310C200 345 230 370 265 370C300 370 330 345 330 310H200Z" fill="currentColor" transform="translate(0, -50)" />
                  <circle cx="265" cy="150" r="70" fill="currentColor" />
              ...
              <h3 className="text-xs sm:text-[13px] font-medium">เปรียบเทียบ</h3>
            </Link>
          </div>
