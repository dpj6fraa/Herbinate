    ...
    return (
        <nav className="sticky top-0 w-full bg-white border-b-4 border-b-[#97DB8B] flex flex-col text-[24px] sm:px-6 z-50">
            <div className="flex justify-between items-center">
                ...
                <div>
                    <div className="bg-gray-200 w-11 h-11 rounded-full"></div>
                </div>
            </div>
            ...
            <div className="flex justify-around md:justify-center gap-10 pb-2">
                ...
                <div className="flex flex-col items-center mt-2 cursor-pointer">
                    <Link href="" className="flex flex-col items-center px-2 cursor-pointer">
                        ...
                        <h3 className="text-[14px] text-black font-medium">หน้าแรก</h3>
                    </Link>
                </div>
                ...
                <div className="flex flex-col items-center mt-2 cursor-pointer">
                    <Link href="" className="flex flex-col items-center px-2 cursor-pointer">
                        ...
                        <h3 className="text-[14px] text-black font-medium">ชุมชน</h3>
                    </Link>
                </div>
                ...
                <div className="flex flex-col items-center mt-2 cursor-pointer">
                    <Link href="" className="flex flex-col items-center px-2 cursor-pointer">
                        ...
                        <h3 className="text-[14px] text-black font-medium">ค้นหาอาการ</h3>
                    </Link>
                </div>
                ...
                <div className="flex flex-col items-center mt-2 cursor-pointer">
                    <Link href="" className="flex flex-col items-center px-2 cursor-pointer">
                        ...
                        >
                            ...
                            <path
                                d="M11.8 19C11.8 19 5.5 17.5 5 13C4.5 9.5 9 9 11.8 14"
                                fill="black"
                            />
                            <path
                                d="M12.2 19C12.2 19 18.5 17.5 19 13C19.5 9.5 15 9 12.2 14"
                                fill="black"
                            />
                            <path
                                d="M12 16C14 14 15 11 12 5C9 11 10 14 12 16Z"
                                fill="black"
                            />
                        </svg>
                        <h3 className="text-[14px] text-black font-medium">ค้นหารูป</h3>
                    </Link>
                </div>
                ...
                <div className="flex flex-col items-center mt-2 cursor-pointer">
                    <Link href="" className="flex flex-col items-center px-2 cursor-pointer">
                        ...
                        <h3 className="text-[14px] text-black font-medium">เปรียบเทียบ</h3>
                    </Link>
                </div>
            </div>
        </nav >
